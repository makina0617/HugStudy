...
public class SubjectController {
  ...
  /**
   ...
   public String subjectDetail(@PathVariable  Integer id, Model model) {
   ...
   public String subjectEdit(@PathVariable  Integer id, Model model) {
       SubjectEntity subject = subjectService.findById(id);
       ...
       subjectUpdateRequest.setAddress(subject.getAddress());
       subjectUpdateRequest.setPhone(subject.getPhone());
       subjectUpdateRequest.setVisitingtime(subject.getVisitingtime());
